...
final List<QuestionModel> stageFourQuestions = [
  QuestionModel(
    question: '1- هل سبق لك استخدام الذكاء الاصطناعي مساعد الطيار في الممارسة العملية؟',
    answers: [
      'نعم',
      'لا'
    ],
  ...
  QuestionModel(
    question: '2- ما هي فوائد استخدام الذكاء الاصطناعي مساعد الطيار في الممارسة التمريضية؟',
    answers: [
  ...
  QuestionModel(
    question: '3- ما هي مزايا استخدام الذكاء الاصطناعي مساعد الطيار؟',
    answers: [
  ...
  QuestionModel(
    question: '4- ما هي عيوب استخدام الذكاء الاصطناعي مساعد الطيار في الممارسة التمريضية؟',
    answers: [
  ...
  QuestionModel(
    question: '5- ما هي التحديات التي تواجه استخدام الذكاء الاصطناعي مساعد الطيار في الممارسة التمريضية؟',
    answers: [
  ...
  QuestionModel(
    question: '6- ما هي معوقات استخدام الذكاء الاصطناعي مساعد الطيار في الممارسة التمريضية؟',
    answers: [
